...
/// @author belbix
contract SmartVaultV110 is Initializable, ERC20Upgradeable, VaultStorageV110, ControllableV2 {
  ...
  function initializeSmartVault(
    ...
    VaultStorageV110.initializeVaultStorage(
      __underlying,
      _duration,
      _lockAllowed
    );
