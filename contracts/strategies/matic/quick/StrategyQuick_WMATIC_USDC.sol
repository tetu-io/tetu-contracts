...
contract StrategyQuick_WMATIC_USDC is SNXStrategyFullBuyback {

  // QUICK_WMATIC_USDC
  address private constant UNDERLYING = address(0x6e7a5FAFcec6BB1e78bAE2A1F0B612012BF14827);
  // WMATIC
  ...
  address private constant QUICK_REWARD_POOL = address(0x6C6920aD61867B86580Ff4AfB517bEc7a499A7Bb);
