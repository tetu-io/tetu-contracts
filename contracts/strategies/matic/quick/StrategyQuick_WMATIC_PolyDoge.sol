...
contract StrategyQuick_WMATIC_PolyDoge is SNXStrategyFullBuyback {

  // QUICK_WMATIC_PolyDoge
  address private constant UNDERLYING = address(0x264e6BC3f95633725658e4D9640f7F7D9100F6AC);
  // WMATIC
  ...
  address private constant QUICK_REWARD_POOL = address(0x774685013B4248c9f7ddE063cfBdA0a87269C0Cd);
