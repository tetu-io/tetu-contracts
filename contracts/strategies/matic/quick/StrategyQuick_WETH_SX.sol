...
contract StrategyQuick_WETH_SX is SNXStrategyFullBuyback {

  // QUICK_WETH_SX
  address private constant UNDERLYING = address(0x3Ff616172e87429A037e4B42843FB11bF0C945bB);
  // WETH
  address private constant TOKEN0 = address(0x7ceB23fD6bC0adD59E62ac25578270cFf1b9f619);
  // SX
  address private constant TOKEN1 = address(0x840195888Db4D6A99ED9F73FcD3B225Bb3cB1A79);
  address private constant QUICK_REWARD_POOL = address(0x225d8F0f5FB5D66cA7C0a27da85F462689c47C23);
