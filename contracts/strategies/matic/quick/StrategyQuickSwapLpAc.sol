...
import "../../../base/strategies/snx-base/QuickStrategyBaseAC.sol";
import "../../../third_party/quick/IStakingRewards.sol";
import "../../../third_party/uniswap/IUniswapV2Pair.sol";

/// @title QuickStrategyBaseAC implementation for QuickSwap platform
/// @author belbix
contract StrategyQuickSwapLpAc is QuickStrategyBaseAC {
  ...
  ) QuickStrategyBaseAC(_controller, _underlying, _vault, _quickRewardPool, QUICK_ROUTER) {
