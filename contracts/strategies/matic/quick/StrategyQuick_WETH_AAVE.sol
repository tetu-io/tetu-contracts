...
contract StrategyQuick_WETH_AAVE is SNXStrategyFullBuyback {

  // QUICK_WETH_AAVE
  address private constant UNDERLYING = address(0x90bc3E68Ba8393a3Bf2D79309365089975341a43);
  // WETH
  ...
  address private constant QUICK_REWARD_POOL = address(0x573bb5CCC26222d8108EdaCFcC7F7cb9e388Af10);
