...
contract StrategyQuick_WMATIC_ERN is SNXStrategyFullBuyback {

  // QUICK_WMATIC_ERN
  address private constant UNDERLYING = address(0x124dE7e03b8Ee7363974d5ca3b1868DDf3a23cD3);
  // WMATIC
  address private constant TOKEN0 = address(0x0d500B1d8E8eF31E21C99d1Db9A6444d3ADf1270);
  // ERN
  address private constant TOKEN1 = address(0x0E50BEA95Fe001A370A4F1C220C49AEdCB982DeC);
  address private constant QUICK_REWARD_POOL = address(0xA8F8A46f5dD3F68D2B7B1b04Dd20526CebCE7E7A);
