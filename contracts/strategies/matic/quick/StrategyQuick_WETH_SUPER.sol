...
contract StrategyQuick_WETH_SUPER is SNXStrategyFullBuyback {

  // QUICK_WETH_SUPER
  address private constant UNDERLYING = address(0x0712323F8451Cf7acc1141083baa60cc70Dc32A8);
  // WETH
  ...
  address private constant QUICK_REWARD_POOL = address(0x214249a7bd9a6C10AdfF8fAd70749ebf8108494a);
