...
contract StrategySushi_USDC_DAI is MCv2StrategyFullBuyback {

  // SUSHI_USDC_DAI
  address private constant _UNDERLYING = address(0xCD578F016888B57F1b1e3f887f392F0159E26747);
  // USDC
...
// DAI
  ...
  constructor(
    address _controller,
    address _vault
  ) MCv2StrategyFullBuyback(_controller, _UNDERLYING, _vault, sushiPoolRewards, _MASTER_CHEF_REWARD_POOL, 11) {
  }
