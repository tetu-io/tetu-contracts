...
contract StrategySushi_LINK_WETH is MCv2StrategyFullBuyback {

  // SUSHI_LINK_WETH
  address private constant _UNDERLYING = address(0x74D23F21F780CA26B47Db16B0504F2e3832b9321);
  // LINK
...
// WETH
  ...
  constructor(
    address _controller,
    address _vault
  ) MCv2StrategyFullBuyback(_controller, _UNDERLYING, _vault, sushiPoolRewards, _MASTER_CHEF_REWARD_POOL, 7) {
  }
