...
contract StrategySushi_WETH_DAI is MCv2StrategyFullBuyback {

  // SUSHI_WETH_DAI
  address private constant _UNDERLYING = address(0x6FF62bfb8c12109E8000935A6De54daD83a4f39f);
  // WETH
...
// DAI
  ...
  constructor(
    address _controller,
    address _vault
  ) MCv2StrategyFullBuyback(_controller, _UNDERLYING, _vault, sushiPoolRewards, _MASTER_CHEF_REWARD_POOL, 5) {
  }
