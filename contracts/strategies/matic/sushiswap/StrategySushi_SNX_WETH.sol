...
contract StrategySushi_SNX_WETH is MCv2StrategyFullBuyback {

  // SUSHI_SNX_WETH
  address private constant _UNDERLYING = address(0x116Ff0d1Caa91a6b94276b3471f33dbeB52073E7);
  // SNX
...
// WETH
  ...
  constructor(
    address _controller,
    address _vault
  ) MCv2StrategyFullBuyback(_controller, _UNDERLYING, _vault, sushiPoolRewards, _MASTER_CHEF_REWARD_POOL, 10) {
  }
