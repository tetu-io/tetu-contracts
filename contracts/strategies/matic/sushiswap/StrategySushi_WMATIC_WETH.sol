...
contract StrategySushi_WMATIC_WETH is MCv2StrategyFullBuyback {

  // SUSHI_WMATIC_WETH
  address private constant _UNDERLYING = address(0xc4e595acDD7d12feC385E5dA5D43160e8A0bAC0E);
  // WMATIC
...
// WETH
  ...
  constructor(
    address _controller,
    address _vault
  ) MCv2StrategyFullBuyback(_controller, _UNDERLYING, _vault, sushiPoolRewards, _MASTER_CHEF_REWARD_POOL, 0) {
  }
