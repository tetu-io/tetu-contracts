...
contract StrategyWault_WMATIC_FISH is WaultStrategyFullBuyback {

  // WAULT_WMATIC_FISH
  address private constant _UNDERLYING = address(0x44825bf3B74695bD72ED247D62DD755e67B7ED87);
  // WMATIC
  ...
  constructor(
    address _controller,
    address _vault
  ) WaultStrategyFullBuyback(_controller, _UNDERLYING, _vault, poolRewards, WEX_POLY_MASTER, 20) {
  }
