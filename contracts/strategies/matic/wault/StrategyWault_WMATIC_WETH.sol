...
contract StrategyWault_WMATIC_WETH is WaultStrategyFullBuyback {

  // WAULT_WMATIC_WETH
  address private constant _UNDERLYING = address(0x679B8Ab80F298bF802fB294137765C6386D43dcA);
  // WMATIC
  ...
  constructor(
    address _controller,
    address _vault
  ) WaultStrategyFullBuyback(_controller, _UNDERLYING, _vault, poolRewards, WEX_POLY_MASTER, 4) {
  }
