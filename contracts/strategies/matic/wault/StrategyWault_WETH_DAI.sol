...
contract StrategyWault_WETH_DAI is WaultStrategyFullBuyback {

  // WAULT_WETH_DAI
  address private constant _UNDERLYING = address(0xaEF35d720C56eF3c259BCCdB6931F331c7f15b3F);
  // WETH
  ...
  constructor(
    address _controller,
    address _vault
  ) WaultStrategyFullBuyback(_controller, _UNDERLYING, _vault, poolRewards, WEX_POLY_MASTER, 11) {
  }
