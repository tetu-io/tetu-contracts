...
export class TokenUtils {
  ...
  public static TOKEN_HOLDERS = new Map<string, string>([
    ...
    [
      ...
      '0x070f5A78963a658d3b8700BAF8e3C08984514eA2'.toLowerCase(),
    ],
    ...
    [
      ...
      '0x1a13f4ca1d028320a707d99520abfefca3998b7f'.toLowerCase(),
    ], // aave
    [
      MaticAddresses.USDT_TOKEN,
      '0x0D0707963952f2fBA59dD06f2b425ace40b492Fe'.toLowerCase(),
    ], // adr
    [
      MaticAddresses.QUICK_TOKEN,
      '0xdB74C5D4F154BBD0B8e0a28195C68ab2721327e5'.toLowerCase(),
    ], // dquick
    [
      MaticAddresses.FRAX_TOKEN,
      '0x45c32fa6df82ead1e2ef74d17b76547eddfaff89'.toLowerCase(),
    ], // frax
    [
      MaticAddresses.TETU_TOKEN,
      '0x7ad5935ea295c4e743e4f2f5b4cda951f41223c2'.toLowerCase(),
    ], // fund keeper
    [
      MaticAddresses.AAVE_TOKEN,
      '0x1d2a0e5ec8e5bbdca5cb219e649b565d8e5c3360'.toLowerCase(),
    ], // aave
    [
      MaticAddresses.SUSHI_TOKEN,
      '0x1b1cd0fdb6592fe482026b8e47706eac1ee94a7c'.toLowerCase(),
    ], // peggy
    [
    ...
    [
      ...
      '0xb1bf26c7b43d2485fa07694583d2f17df0dde010'.toLowerCase(),
    ], // blueIce
    [
      MaticAddresses.IRON_TOKEN,
      '0xCaEb732167aF742032D13A9e76881026f91Cd087'.toLowerCase(),
    ], // ironSwap
    ...
    [
      MaticAddresses.LINK_TOKEN,
      '0xBA12222222228d8Ba445958a75a0704d566BF2C8'.toLowerCase(),
    ], // balancer
    [
      MaticAddresses.CRV_TOKEN,
      '0x98B5F32dd9670191568b661a3e847Ed764943875'.toLowerCase(),
    ], // qi
    [
      MaticAddresses.DINO_TOKEN,
      '0x000000000000000000000000000000000000dead'.toLowerCase(),
    ...
    [
      ...
      '0xe578c856933d8e1082740bf7661e379aa2a30b26'.toLowerCase(),
    ], // geist
    [
      FtmAddresses.fUSDT_TOKEN,
      '0x940f41f0ec9ba1a34cf001cc03347ac092f5f6b5'.toLowerCase(),
    ], // geist
    [
      FtmAddresses.WFTM_TOKEN,
      '0x39b3bd37208cbade74d0fcbdbb12d606295b430a'.toLowerCase(),
    ], // geist
    [
      FtmAddresses.WBTC_TOKEN,
      '0x38aca5484b8603373acc6961ecd57a6a594510a3'.toLowerCase(),
    ], // geist
    [
      FtmAddresses.CRV_TOKEN,
      '0xd4F94D0aaa640BBb72b5EEc2D85F6D114D81a88E'.toLowerCase(),
    ], // geist
    [
      FtmAddresses.YFI_TOKEN,
      '0x0845c0bfe75691b1e21b24351aac581a7fb6b7df'.toLowerCase(),
    ], // yearn
    [
      FtmAddresses.FUSD_TOKEN,
      '0x3bfC4807c49250b7D966018EE596fd9D5C677e3D'.toLowerCase(),
    ], // wallet
    [
      FtmAddresses.LINK_TOKEN,
      '0xd061c6586670792331E14a80f3b3Bb267189C681'.toLowerCase(),
    ], // Spirit LPs (SPIRIT-LP)
    [
      FtmAddresses.DOLA_TOKEN,
      '0x4d7928e993125A9Cefe7ffa9aB637653654222E2'.toLowerCase(),
    ], // xChainFed
    [
      FtmAddresses.MIM_TOKEN,
      '0x2dd7c9371965472e5a5fd28fbe165007c61439e1'.toLowerCase(),
    ], // curve pool
    [
      FtmAddresses.BIFI_TOKEN,
      '0x7fb900c14c9889a559c777d016a885995ce759ee'.toLowerCase(),
    ], // BeefyRewardPool
    [
      FtmAddresses.TUSD_TOKEN,
      '0xa3abb8bcc6ffea82d3a0a8f800050f684db27db8'.toLowerCase(),
    ], // Some strategy
    [
      FtmAddresses.FBTC_TOKEN,
      '0x1f45Df42E81892260f50A256bBE7120d6624c2F1'.toLowerCase(),
    ], // wallet
    [
      FtmAddresses.FETH_TOKEN,
      '0x15a3f675184a4e09877ed10ad8080438ea9e35ae'.toLowerCase(),
    ], // wallet
    [
      MaticAddresses.FXS_TOKEN,
      '0x1a3acf6d19267e2d3e7f898f42803e90c9219062'.toLowerCase(),
    ], // itself
    [
      MaticAddresses.AM3CRV_TOKEN,
      '0xA1C4Aac752043258c1971463390013e6082C106f'.toLowerCase(),
    ], // wallet
    [
    ...
    [
      ...
      '0x5342D9085765baBF184e7bBa98C9CB7528dfDACE'.toLowerCase(),
    ], // wallet
    [
      FtmAddresses.USD_BTC_ETH_CRV_TOKEN,
      '0x00702bbdead24c40647f235f15971db0867f6bdb'.toLowerCase(),
    ], // gauge
    [
      MaticAddresses.BTCCRV_TOKEN,
      '0xffbACcE0CC7C19d46132f1258FC16CF6871D153c'.toLowerCase(),
    ], // gauge
    [
    ...
    [
      ...
      '0x25864a712C80d33Ba1ad7c23CffA18b46F2fc00c'.toLowerCase(),
    ],
    [
      FtmAddresses.WBTC_TOKEN,
      '0x38aca5484b8603373acc6961ecd57a6a594510a3'.toLowerCase(),
    ...
    [
      ...
      '0x25c130b2624cf12a4ea30143ef50c5d68cefa22f'.toLowerCase(),
    ], // geist
    [
      MaticAddresses.KLIMA_TOKEN,
      '0x65A5076C0BA74e5f3e069995dc3DAB9D197d995c'.toLowerCase(),
    ], // gnosis
    [
      FtmAddresses._2poolCrv_TOKEN,
      '0x8866414733F22295b7563f9C5299715D2D76CAf4'.toLowerCase(),
    ], // gauge
    [
      FtmAddresses.renCRV_TOKEN,
      '0xBdFF0C27dd073C119ebcb1299a68A6A92aE607F0'.toLowerCase(),
    ], // gauge
    [
      MaticAddresses.PSP_TOKEN,
      '0x2ee05fad3b206a232e985acbda949b215c67f00e'.toLowerCase(),
    ], // wallet
    [
    ...
    [
      FtmAddresses.FRAX_TOKEN,
      '0x7a656B342E14F745e2B164890E88017e27AE7320'.toLowerCase(),
    ], // curve pool
    [
  ...
  public static async approveNFT(
    tokenAddress: string,
    signer: SignerWithAddress,
    spender: string,
    id: string
