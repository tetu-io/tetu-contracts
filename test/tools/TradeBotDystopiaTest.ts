...
import {TradeBot, TradeBotDystopia} from "../../typechain";
...
const ROUTER = MaticAddresses.DYSTOPIA_ROUTER;
...
describe("TradeBotDystopia test", function () {
  let snapshot: string;
  let snapshotForEach: string;
  let owner: SignerWithAddress;
  let executor: SignerWithAddress;
  let bot: TradeBotDystopia;
  ...
  before(async function () {
    ...
    bot = await DeployerUtils.deployContract(owner, 'TradeBotDystopia') as TradeBotDystopia;
  });
