...
import {PriceCalculator, StrategyScreamFold} from "../../../../typechain";
...
async function startScreamFoldStrategyTest(
  strategyName: string,
  factory: string,
  underlying: string,
  tokenName: string,
...
export {startScreamFoldStrategyTest};
