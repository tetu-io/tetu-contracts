...
import {startAaveFoldStrategyProfitabilityTest} from "./AaveFoldStrategyTestBase";
...
describe('Aave Fold profitability tests', async () => {
  ...
  infos.forEach(info => {
    ...
    startAaveFoldStrategyProfitabilityTest(
        'StrategyAaveFold',
