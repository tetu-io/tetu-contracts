...
export default async function main() {
  ...
  const announcerData = [core.announcer, '0xdF837f0327Bbf85b066c400f17b2B2727F94cb2f']

  const feeRewardForwarderData = [core.feeRewardForwarder, '0x0A0846c978a56D6ea9D2602eeb8f977B21F3207F'];

  const bookkeeperLogic = '0x7AD5935EA295c4E743e4f2f5B4CDA951f41223c2'
  const bookkeeper = core.bookkeeper

  const fundKeeperData = [core.fundKeeper, '0x2A3df2a428EB74B241Cf1d3374Fb07983c7059F3']

  const vaultControllerData = [core.vaultController, '0x35B0329118790B8c8FC36262812D92a4923C6795']
  ...
  await DeployerUtils.verifyWithArgs(feeRewardForwarderData[0], [feeRewardForwarderData[1]]);
  ...
  await DeployerUtils.verifyWithArgs(vaultControllerData[0], [vaultControllerData[1]]);
