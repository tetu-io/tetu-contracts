...
async function main() {
  ...
  await DeployerUtils.verifyWithContractName(
    strategy.address,
    'contracts/strategies/fantom/curve/CurveTriCryptoFtmStrategy.sol:CurveTriCryptoFtmStrategy',
    [core.controller, FtmAddresses.USD_BTC_ETH_CRV_TOKEN, vault.address],
  );
