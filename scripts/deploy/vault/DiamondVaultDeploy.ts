...
async function main() {
  ...
  const strategy = await DeployerUtils.deployContract(signer, "NoopStrategy",
      core.controller, core.psVault, vault.address, [], [core.psVault], 1) as NoopStrategy;
  ...
  await DeployerUtils.verifyWithContractName(strategy.address, 'contracts/base/strategies/NoopStrategy.sol:NoopStrategy', [
