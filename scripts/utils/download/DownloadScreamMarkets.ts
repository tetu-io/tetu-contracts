...
const exclude = new Set<number>([2, 4, 5, 6, 9, 11, 12, 13, 15, 16, 22]);
...
async function main() {
  ...
  let infos =
    'idx, csToken_name, csToken_address, token, tokenName, collateralFactor, borrowTarget, tvl, supplyCap, vault, cur rewards \n';
